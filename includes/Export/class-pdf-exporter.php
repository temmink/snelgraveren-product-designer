...
class PdfExporter {
     ...
     *
     * Each view becomes a separate page sized to its canvas dimensions.
     *
    ...
    private function render_text(\TCPDF $pdf, array $obj): void {
        ...
        // TCPDF uses top-left positioning
        $pdf->SetXY($left, $top);
        $pdf->MultiCell(0, $actual_size * 1.16, $text, 0, 'L', false, 1, $left, $top);
    }
    ...
    private function render_image(\TCPDF $pdf, array $obj): void {
        ...
        // Convert URL to local path if it's on this server
